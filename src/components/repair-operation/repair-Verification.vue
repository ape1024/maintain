              ...
              <li class="verificationLifour">
                <div class="verificationLithreeDiv">
                  ...
                  <el-radio-group v-model="approvalradio">
                    <el-radio disabled  :key="index" v-for="(item, index) in approvaloptions" :label="item.value">{{item.name}}</el-radio>
                  </el-radio-group>
                </div>
                <div class="verificationLithreeDivtwo">
                  <span>审核意见：</span>
                  <span class="differingOpinion"><el-input disabled size="mini" v-model="approvalOpinionInput" placeholder="请输入内容"></el-input></span>
                </div>
                <!--<div class="verificationLithreeDiv">-->
      ...
      <section class="classification">
        ...
        <div class="assortment">
          <div class="fastener">
            ...
            <!--<div @click="conserve" class="conserve">验证</div>-->
...
import { maintainRepairapprovalTask, maintainRepaircheckTask, maintainRepairgetRepariTaskApprovalItem, maintainRepairfindReworksByTaskid } from '../../api/user'
export default {
  ...
  created () {
    if (this.examina) {
      ...
      this.approvalradio = this.examina.approvalstate
      this.approvalOpinionInput = this.examina.approvalopinion
    } else {
    }
